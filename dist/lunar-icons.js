...
module.exports={
    ...
    "app_store": "<path d=\"M19.408 15.386h-1.492l1.014 1.752a1.062 1.062 0 0 1-.78 1.582 1.06 1.06 0 0 1-1.057-.521l-3.76-6.516a7.386 7.386 0 0 0-.186-.347 2.893 2.893 0 0 1 .434-3.464l3.114 5.393h2.716a1.061 1.061 0 1 1-.003 2.12zm-9.682-2.121h3.127a1.542 1.542 0 0 1 1.43 2.12H4.56a1.06 1.06 0 0 1 0-2.12h2.717l3.482-6.033-1.091-1.891a1.06 1.06 0 1 1 1.837-1.06l.48.832.479-.833A1.06 1.06 0 1 1 14.3 5.34l-4.575 7.925zm-3.92 2.548a2.878 2.878 0 0 1 2.165.492L6.877 18.2a1.06 1.06 0 1 1-1.837-1.06l.765-1.325z\" fill=\"currentColor\"/><circle cx=\"12\" cy=\"12\" r=\"11\" stroke=\"currentColor\" stroke-width=\"2\"/>",
    ...
    "google_play": {
        "path": "<path d=\"M2.922.011a1.742 1.742 0 0 0-.412.003c-.023.002-.044 0-.066.004a1.2 1.2 0 0 0-.708.312C1.266.684 1 1.286 1 1.804v20.509c0 .519.247 1.18.842 1.503.594.322 1.266.176 1.708-.091l.003-.003c-.072.044.332-.19.841-.48l2.058-1.168 6.098-3.448c2.21-1.25 4.424-2.5 6.116-3.458.845-.478 1.559-.883 2.079-1.179.518-.294.774-.44.93-.534.466-.283.938-.828.929-1.53-.01-.704-.483-1.217-.931-1.47l-8.962-5.066-6.055-3.427C5.82 1.488 5.112 1.085 4.601.794c-.512-.29-.898-.514-.858-.49H3.74a2.118 2.118 0 0 0-.818-.293zM3.4 4.02l6.909 7.93L3.4 19.883V4.02zm4.316 1.3l3.814 2.157 1.79 1.013-1.42 1.631-4.184-4.8zm7.736 4.373l4.006 2.264-1.976 1.123-2.021 1.144a1.17 1.17 0 0 0-.075-.101l-1.894-2.173 1.894-2.175c.023-.027.045-.054.066-.082zM11.9 13.778l1.435 1.646-1.967 1.113-3.687 2.087 4.22-4.846z\" fill=\"currentColor\"/>",
        "mask": "<path fill=\"#fff\" d=\"M0 0h24v24H0z\"/>"
    },
